...
BEGIN
    ...
    CREATE INDEX wordlist_word_dmetaphone_idx ON public.wordlist USING GIN(dmetaphone(word) gin_trgm_ops);
    CREATE INDEX wordlist_word_dmetaphone_alt_idx ON public.wordlist USING GIN(dmetaphone_alt(word) gin_trgm_ops);
